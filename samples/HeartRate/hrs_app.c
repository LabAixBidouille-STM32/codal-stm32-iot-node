...
void HRS_Notification(HRS_NotCode_t Notification) {
    switch (Notification) {
        ...
        case HRS_NOTIFICATION_ENABLED:
            /**
             * It could be the enable notification is received twice without the disable
...
void HRSAPP_Init(void) {
    ...
    */
    HRSAPP_Context.MeasurementvalueChar.Flags =
        (HRS_HRM_SENSOR_CONTACT_PRESENT | HRS_HRM_SENSOR_CONTACT_SUPPORTED |
         HRS_HRM_ENERGY_EXPENDED_PRESENT | HRS_HRM_RR_INTERVAL_PRESENT);
    ...
    if (HRSAPP_Context.MeasurementvalueChar.Flags & HRS_HRM_RR_INTERVAL_PRESENT) {
        ...
        HRSAPP_Context.MeasurementvalueChar.NbreOfValidRRIntervalValues =
            BLE_CFG_HRS_ENERGY_RR_INTERVAL_FLAG;
